...
public class ThumbnailGallerySnippet extends Application {
	...
	public void start(final Stage stage) throws Exception {
		...
		final String[] urlsThumbnails = new String[] {
				"http://carlosmontero.es/photoprovider/portfolio/2/false/thumbail/15",
				"http://carlosmontero.es/photoprovider/portfolio/2/false/thumbail/16",
				"http://carlosmontero.es/photoprovider/portfolio/2/false/thumbail/17",
				"http://carlosmontero.es/photoprovider/portfolio/2/false/thumbail/18",
				"http://carlosmontero.es/photoprovider/portfolio/2/false/thumbail/19",
				"http://carlosmontero.es/photoprovider/portfolio/2/false/thumbail/20",
				"http://carlosmontero.es/photoprovider/portfolio/2/false/thumbail/21",
				"http://carlosmontero.es/photoprovider/portfolio/2/false/thumbail/22",
				"http://carlosmontero.es/photoprovider/portfolio/2/false/thumbail/23",
				"http://carlosmontero.es/photoprovider/portfolio/2/false/thumbail/24",
				"http://carlosmontero.es/photoprovider/portfolio/2/false/thumbail/25",
				"http://carlosmontero.es/photoprovider/portfolio/2/false/thumbail/26",
				"http://carlosmontero.es/photoprovider/portfolio/2/false/thumbail/27",
				"http://carlosmontero.es/photoprovider/portfolio/2/false/thumbail/28",
				"http://carlosmontero.es/photoprovider/portfolio/2/false/thumbail/29",
				"http://carlosmontero.es/photoprovider/portfolio/2/false/thumbail/30",
				"http://carlosmontero.es/photoprovider/portfolio/2/false/thumbail/31" };
		...
		for (int i = 0; i < urls.length; i++) {
			photos.add(new PhotoGallery(urlsThumbnails[i], urls[i]));
		}
